...
User.prototype = {
  ...
  update: function update(name, email, userType) {
    this.name = name;
    this.email = email;
  ...
  bookLookUp: function bookLookUp(name) {
