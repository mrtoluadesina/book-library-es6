...
Book.prototype = {
  ...
  edit: function edit(id, name, quantity) {
  ...
  bookRequest: function bookRequest(bookId, duration, userId, userName, userPriority) {
  ...
  returnABook: function returnABook(bookId) {
    for (var index = 0; index < db.books.length; index++) {
